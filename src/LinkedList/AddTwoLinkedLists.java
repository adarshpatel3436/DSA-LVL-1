...
public class AddTwoLinkedLists {
    ...
    public static class LinkedList {
        ...
        public static int addListHelper(Node one, int pv1, Node two, int pv2, LinkedList res){ // pv1 - place value of 1
        ...
        public static LinkedList addTwoLists(LinkedList one, LinkedList two) {
            ...
            int oc = addListHelper(one.head, one.size, two.head, two.size, res); // oc - old carry
            if(oc > 0){
                res.addFirst(oc);
            }
            return res;
...
//        l1.reversePR();
        ...
        LinkedList ans = LinkedList.addTwoLists(l1, l2);
